  ...
  return (
    <div className="min-h-screen bg-[#f4f7f3] text-[#1e352b]">
      ...
      <section className="pt-36 pb-20 px-6 relative overflow-hidden bg-[linear-gradient(110deg,#0a231b_0%,#0d2b21_55%,#12382a_100%)]">
        ...
        <div className="absolute top-44 right-[8%] w-6 h-6 bg-[#e3b23c]/25 rounded-full animate-float2" />
        <div className="absolute bottom-16 left-[12%] w-6 h-6 bg-[#e3b23c]/35 rounded-full animate-float3" />
        <div className="absolute bottom-28 right-[6%] w-6 h-6 bg-[#e3b23c]/30 rounded-full animate-float1" />
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-offwhite leading-[1.1] tracking-[-1px] mb-6">
            The <span className="text-gold [text-shadow:0_0_28px_rgba(227,178,60,0.34)]">Profit</span> Machine Method
          </h1>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <p className="flex items-center gap-2.5 text-[13px] tracking-[3px] text-[#6f8a7c] font-semibold uppercase mb-3"><span className="w-[9px] h-[9px] rounded-full bg-gold flex-shrink-0" />Layer 1</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              <div className="w-12 h-12 bg-[#e3b23c]/10 rounded-xl flex items-center justify-center mb-5">
              ...
              <h3 className="text-xl font-semibold text-[#123b2d] mb-3">Unit economics</h3>
              <p className="text-[#6f8a7c] leading-relaxed mb-4">
              ...
              <ul className="text-[#6f8a7c] text-sm space-y-1.5">
            ...
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              ...
              <h3 className="text-xl font-semibold text-[#123b2d] mb-3">Capital efficiency</h3>
              <p className="text-[#6f8a7c] leading-relaxed mb-4">
            ...
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              ...
              <h3 className="text-xl font-semibold text-[#123b2d] mb-3">Margin consistency</h3>
              <p className="text-[#6f8a7c] leading-relaxed mb-4">
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <p className="flex items-center gap-2.5 text-[13px] tracking-[3px] text-[#6f8a7c] font-semibold uppercase mb-3"><span className="w-[9px] h-[9px] rounded-full bg-gold flex-shrink-0" />Layer 2</p>
          <h2 className="text-3xl font-bold text-[#1e352b] mb-4 pb-4 border-b-2 border-[#dde8e0]">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#1e352b]">Fragmentation</h3>
              </div>
              <p className="text-[#6f8a7c] text-sm font-medium mb-3">The machine is blind</p>
              <p className="text-[#6f8a7c] text-sm leading-relaxed mb-4">
                Data exists across disconnected systems. Nobody has joined it up.
                Basic questions take a week to answer instead of an hour.
              </p>
              <div className="bg-[#f4f7f3] rounded-lg p-4">
                <p className="text-[#6f8a7c] text-xs italic">
            ...
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#1e352b]">Inherited belief</h3>
              </div>
              <p className="text-[#6f8a7c] text-sm font-medium mb-3">The machine is misjudged</p>
              <p className="text-[#6f8a7c] text-sm leading-relaxed mb-4">
            ...
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#1e352b]">Handoff leaks</h3>
              </div>
              <p className="text-[#6f8a7c] text-sm font-medium mb-3">The machine is leaking</p>
              <p className="text-[#6f8a7c] text-sm leading-relaxed mb-4">
            ...
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#1e352b]">Political silence</h3>
              </div>
              <p className="text-[#6f8a7c] text-sm font-medium mb-3">The machine is protected</p>
              <p className="text-[#6f8a7c] text-sm leading-relaxed mb-4">
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <p className="flex items-center gap-2.5 text-[13px] tracking-[3px] text-[#6f8a7c] font-semibold uppercase mb-3"><span className="w-[9px] h-[9px] rounded-full bg-gold flex-shrink-0" />Layer 3</p>
          <h2 className="text-3xl font-bold text-[#1e352b] mb-4 pb-4 border-b-2 border-[#dde8e0]">
            How we work
          </h2>
          <p className="text-[#6f8a7c] mb-14 max-w-2xl">
          ...
          <div className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row md:items-start gap-6">
                <div className="flex-shrink-0">
                  <div className="w-14 h-14 bg-gold rounded-full flex items-center justify-center">
                    <span className="text-[#123b2d] font-bold text-lg">1</span>
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-[#1e352b] mb-1">X-Ray</h3>
                  <p className="text-[#6f8a7c] text-sm font-medium mb-3">See the machine</p>
                  <p className="text-[#6f8a7c] leading-relaxed mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">5 business days</span>
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">Fixed fee</span>
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">Top 3 opportunities identified</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              <div className="flex flex-col md:flex-row md:items-start gap-6">
                <div className="flex-shrink-0">
                  <div className="w-14 h-14 bg-gold rounded-full flex items-center justify-center">
                    <span className="text-[#123b2d] font-bold text-lg">2</span>
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-[#1e352b] mb-1">Diagnosis</h3>
                  <p className="text-[#6f8a7c] text-sm font-medium mb-3">Size the gaps</p>
                  <p className="text-[#6f8a7c] leading-relaxed mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">Every gap sized in pounds</span>
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">Prioritised by impact and speed</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              <div className="flex flex-col md:flex-row md:items-start gap-6">
                <div className="flex-shrink-0">
                  <div className="w-14 h-14 bg-gold rounded-full flex items-center justify-center">
                    <span className="text-[#123b2d] font-bold text-lg">3</span>
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-[#1e352b] mb-1">Intervention</h3>
                  <p className="text-[#6f8a7c] text-sm font-medium mb-3">Fix the leaks</p>
                  <p className="text-[#6f8a7c] leading-relaxed mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">Action-triggering systems</span>
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">Survives personnel changes</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[14px] p-8 shadow-[0_2px_14px_rgba(18,59,45,0.06)]">
              <div className="flex flex-col md:flex-row md:items-start gap-6">
                <div className="flex-shrink-0">
                  <div className="w-14 h-14 bg-gold rounded-full flex items-center justify-center">
                    <span className="text-[#123b2d] font-bold text-lg">4</span>
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-[#1e352b] mb-1">Machine health</h3>
                  <p className="text-[#6f8a7c] text-sm font-medium mb-3">Keep it visible</p>
                  <p className="text-[#6f8a7c] leading-relaxed mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">Real-time health dashboard</span>
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">Early warning alerts</span>
                    <span className="px-3 py-1 bg-[#e8f0ea] rounded-full text-xs font-medium text-[#6f8a7c]">Investor-grade reporting</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        <div className="absolute top-12 left-[6%] w-6 h-6 bg-[#e3b23c]/25 rounded-full animate-float2" />
        <div className="absolute top-28 right-[10%] w-6 h-6 bg-[#e3b23c]/30 rounded-full animate-float1" />
        <div className="absolute bottom-16 left-[14%] w-6 h-6 bg-[#e3b23c]/35 rounded-full animate-float3" />
        <div className="absolute bottom-28 right-[5%] w-6 h-6 bg-[#e3b23c]/25 rounded-full animate-float2" />

        <div className="max-w-3xl mx-auto relative z-10">
          <div className="bg-gradient-to-br from-[#e3b23c]/10 to-[#8fc0a9]/20 border border-gold/30 rounded-[14px] p-10 md:p-14 text-center">
            <h2 className="text-3xl font-bold text-[#1e352b] mb-4">
              Where is your machine leaking?
            </h2>
            <p className="text-lg text-[#6f8a7c] mb-8 max-w-xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/assess"
                className="px-8 py-4 bg-gold text-[#123b2d] rounded-full font-semibold shadow-[0_6px_30px_rgba(227,178,60,0.3)] hover:bg-gold-deep transition-colors text-lg"
              >
